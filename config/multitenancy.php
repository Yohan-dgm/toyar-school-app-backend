...
use App\Library\SwitchTDatabaseTask;
use App\Library\TDiscovery;
...
return [
     ...
     *
     */
    'tenant_finder' => TDiscovery::class,
     ...
     */
    'tenant_database_connection_name' => 'pgsqlt',
