...
CREATE SEQUENCE "public"."program_requirement_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
-- ----------------------------
ALTER TABLE
    "public"."program_requirement"
ADD
    CONSTRAINT "program_requirement_pkey" PRIMARY KEY ("id");
...
SELECT
    setval(
        '"public"."program_requirement_id_seq"',
        1,
        false
    );