...
CREATE SEQUENCE "public"."program_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
-- ----------------------------
ALTER SEQUENCE "public"."program_type_id_seq" OWNED BY "public"."program_type"."id";

SELECT
    setval('"public"."program_type_id_seq"', 1, true);