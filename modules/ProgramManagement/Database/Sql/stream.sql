...
CREATE SEQUENCE "public"."stream_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO
    "public"."stream"
VALUES
    ('Main Stream', NULL, NULL, NULL, NULL, 1);

INSERT INTO
    "public"."stream"
VALUES
    ('Mathematics Stream', NULL, NULL, NULL, NULL, 2);

INSERT INTO
    "public"."stream"
VALUES
    ('Biology Stream', NULL, NULL, NULL, NULL, 3);
...
SELECT
    setval('"public"."stream_id_seq"', 3, true);