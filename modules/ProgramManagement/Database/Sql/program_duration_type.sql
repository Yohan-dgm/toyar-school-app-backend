...
CREATE SEQUENCE "public"."program_duration_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
-- ----------------------------
INSERT INTO
    "public"."program_duration_type"
VALUES
    ('Specific Duration', NULL, NULL, NULL, NULL, 1);

INSERT INTO
    "public"."program_duration_type"
VALUES
    ('Recurring Classes', NULL, NULL, NULL, NULL, 2);
...
ALTER TABLE
    "public"."program_duration_type"
ADD
    CONSTRAINT "program_duration_type_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."program_duration_type_id_seq" OWNED BY "public"."program_duration_type"."id";

SELECT
    setval(
        '"public"."program_duration_type_id_seq"',
        2,
        true
    );