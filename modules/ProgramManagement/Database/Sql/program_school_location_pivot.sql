...
CREATE SEQUENCE "public"."program_school_location_pivot_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
CREATE TABLE "public"."program_school_location_pivot" (
    ...
    "id" int8 NOT NULL DEFAULT nextval(
        'program_school_location_pivot_id_seq' :: regclass
    )
);
...
-- ----------------------------
INSERT INTO
    "public"."program_school_location_pivot"
VALUES
    (
        1,
        1,
...
ALTER TABLE
    "public"."program_school_location_pivot"
ADD
    CONSTRAINT "program_school_location_pivot_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."program_school_location_pivot_id_seq" OWNED BY "public"."program_school_location_pivot"."id";

SELECT
    setval(
        '"public"."program_school_location_pivot_id_seq"',
        15,
        true
    );