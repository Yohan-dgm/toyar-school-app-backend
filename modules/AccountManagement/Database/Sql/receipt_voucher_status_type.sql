...
CREATE SEQUENCE "public"."receipt_voucher_status_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
-- ----------------------------
INSERT INTO
    "public"."receipt_voucher_status_type"
VALUES
    (
        NULL,
        NULL,
...
ALTER TABLE
    "public"."receipt_voucher_status_type"
ADD
    CONSTRAINT "receipt_voucher_status_type_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."receipt_voucher_status_type_id_seq" OWNED BY "public"."receipt_voucher_status_type"."id";

SELECT
    setval(
        '"public"."receipt_voucher_status_type_id_seq"',
        2,
        true
    );