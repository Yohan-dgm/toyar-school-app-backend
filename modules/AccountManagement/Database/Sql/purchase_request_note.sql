...
-- ----------------------------
ALTER TABLE
    "public"."tblpurchase_request_note"
ADD
    CONSTRAINT "tblpurchase_request_note_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."purchase_request_note_id_seq" OWNED BY "public"."tblpurchase_request_note"."id";
