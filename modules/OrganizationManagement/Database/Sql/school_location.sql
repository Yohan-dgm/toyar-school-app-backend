...
CREATE SEQUENCE "public"."school_location_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
ALTER TABLE
    "public"."school_location"
ADD
    CONSTRAINT "school_location_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."school_location_id_seq" OWNED BY "public"."school_location"."id";

SELECT
    setval('"public"."school_location_id_seq"', 1, true);