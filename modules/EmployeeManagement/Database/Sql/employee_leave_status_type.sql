...
CREATE SEQUENCE "public"."employee_leave_status_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
-- ----------------------------
INSERT INTO
    "public"."employee_leave_status_type"
VALUES
    (1, 'Approval Pending', NULL, NULL);
...
ALTER TABLE
    "public"."employee_leave_status_type"
ADD
    CONSTRAINT "employee_leave_status_type_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."employee_leave_status_type_id_seq" OWNED BY "public"."employee_leave_status_type"."id";

SELECT
    setval(
        '"public"."employee_leave_status_type_id_seq"',
        4,
        true
    );