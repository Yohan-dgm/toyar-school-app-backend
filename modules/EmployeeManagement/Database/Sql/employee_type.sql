...
CREATE SEQUENCE "public"."employee_type_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
INSERT INTO
    "public"."employee_type"
VALUES
    (2, 'Temporary Employee', NULL, NULL);

INSERT INTO
    "public"."employee_type"
VALUES
    (3, 'Permanent Employee', NULL, NULL);
...
-- ----------------------------
ALTER SEQUENCE "public"."employee_type_id_seq" OWNED BY "public"."employee_type"."id";

SELECT
    setval('"public"."employee_type_id_seq"', 3, true);