...
CREATE SEQUENCE "public"."role_role_group_pivot_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
-- ----------------------------
ALTER TABLE
    "public"."role_role_group_pivot"
ADD
    CONSTRAINT "role_role_group_pivot_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."role_role_group_pivot_id_seq" OWNED BY "public"."role_role_group_pivot"."id";

SELECT
    setval(
        '"public"."role_role_group_pivot_id_seq"',
        1,
        false
    );