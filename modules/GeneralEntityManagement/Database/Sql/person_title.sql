...
CREATE SEQUENCE "public"."person_title_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
ALTER TABLE
    "public"."person_title"
ADD
    CONSTRAINT "person_title_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."person_title_id_seq" OWNED BY "public"."person_title"."id";

SELECT
    setval('"public"."person_title_id_seq"', 7, true);