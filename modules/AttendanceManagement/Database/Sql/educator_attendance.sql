...
CREATE SEQUENCE "public"."educator_attendance_id_seq" INCREMENT 1 MINVALUE 1 MAXVALUE 9223372036854775807 START 1 CACHE 1;
...
ADD
    CONSTRAINT "educator_attendance_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Alter sequences owned by
-- ----------------------------
ALTER SEQUENCE "public"."educator_attendance_id_seq" OWNED BY "public"."educator_attendance"."id";

SELECT
    setval(
        '"public"."educator_attendance_id_seq"',
        1,
        false
    );