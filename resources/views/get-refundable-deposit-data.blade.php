...
<head>
    ...
    <script type="text/javascript">
        var refundable_deposit_id = <?php echo json_encode($refundable_deposit_id); ?>;

        function onBeforeRender(args) {
            var report = args.report;
            report.dictionary.variables.getByName("refundable_deposit_id").valueObject = refundable_deposit_id;
        }
    </script>

    <?php
    $report = new StiReport();
    $report->loadFile("/get-refundable-deposit-data-report");
