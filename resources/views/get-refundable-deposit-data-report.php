{
    ...
    "ReportGuid": "52a1b3c100335a424df71acd1b3243e2",
    "ReportName": "Exam Bill",
    "ReportAlias": "Exam Bill",
    "ReportFile": "/get-refundable-deposit-invoice-data-report.mrt",
    "ReportAuthor": "Solovo Systems",
    "ReportCreated": "/Date(0+0530)/",
    "ReportChanged": "/Date(1746915707000+0530)/",
    ...
    "Dictionary": {
        "Variables": {
            "0": {
                "Value": "25",
                "Name": "refundable_deposit_id",
                "DialogInfo": {
                    "DateTimeType": "DateAndTime",
                    "SortDirection": "None"
                },
                "Alias": "refundable_deposit_id",
                "Type": "System.Int32",
        ...
        "DataSources": {
            ...
            "1": {
                ...
                "Alias": "refundable_deposit",
                "Columns": {
                    "0": {
                        "Name": "bill_total",
                        "NameInSource": "bill_total",
                        "Alias": "bill_total",
                        "Type": "System.Decimal"
                    },
                    "1": {
                    ...
                    "6": {
                        "Name": "is_refundable_deposit_complete",
                        "NameInSource": "is_refundable_deposit_complete",
                        "Alias": "is_refundable_deposit_complete",
                        "Type": "System.Boolean"
                    },
                    "7": {
                        "Name": "items_total",
                        "NameInSource": "items_total",
                        "Alias": "items_total",
                        "Type": "System.Decimal"
                    },
                    "8": {
                    ...
                    "16": {
                        "Name": "service_charges_total",
                        "NameInSource": "service_charges_total",
                        "Alias": "service_charges_total",
                        "Type": "System.Decimal"
                    },
                    "17": {
                        "Name": "student_id",
                    ...
                    "18": {
                        ...
                        "NameInSource": "subtotal_after_discount",
                        "Alias": "subtotal_after_discount",
                        "Type": "System.Decimal"
                    },
                    "19": {
                        "Name": "subtotal_before_discount",
                        "NameInSource": "subtotal_before_discount",
                        "Alias": "subtotal_before_discount",
                        "Type": "System.Decimal"
                    },
                    "20": {
                        "Name": "updated_at",
                ...
                "NameInSource": "PostgreSQL",
                "SqlCommand": "select * from refundable_deposit where id ={refundable_deposit_id}"
            },
            "2": {
                "Ident": "StiPostgreSQLSource",
                "Name": "refundable_deposit_item",
                "Alias": "refundable_deposit_item",
                "Columns": {
                    "0": {
                        "Name": "created_at",
                        "NameInSource": "created_at",
                    ...
                    "4": {
                        "Name": "is_refundable_deposit_item_complete",
                        "NameInSource": "is_refundable_deposit_item_complete",
                        "Alias": "is_refundable_deposit_item_complete",
                        "Type": "System.Boolean"
                    },
                    "5": {
                        "Name": "item_total",
                        "NameInSource": "item_total",
                        "Alias": "item_total",
                        "Type": "System.Decimal"
                    },
                    "6": {
                        "Name": "refundable_deposit_id",
                        "NameInSource": "refundable_deposit_id",
                        "Alias": "refundable_deposit_id",
                        "Type": "System.Int64"
                    },
                    "7": {
                        "Name": "school_fee_id",
                        "NameInSource": "school_fee_id",
                        "Alias": "school_fee_id",
                        "Type": "System.Int64"
                    },
                    "8": {
                ...
                "NameInSource": "PostgreSQL",
                "SqlCommand": "select * from refundable_deposit_item where refundable_deposit_id = {refundable_deposit_id}"
            }
        },
        "Databases": {
            "0": {
                ...
                "ConnectionStringEncrypted": "49DZa01T46RiFYSE5T3gY4tU0cJmWtnBYluhzOF04f/5VNWJTk+76cII+cz7XGI/3sj7KVAFW935W7lh6hjiF8I="
            }
        },
        "Relations": {
            "0": {
                ...
                "ChildSource": "refundable_deposit"
            }
        }
    },
    "Pages": {
                ...
                "0": {
                    ...
                    "Components": {
                        ...
                        "1": {
                            ...
                            "Text": {
                                "Value": "{refundable_deposit.student.full_name_with_title}"
                            },
                            "Font": ";9;;",
                            "Border": ";;;;;;;solid:Black",
                            "Brush": "solid:",
                        ...
                        "2": {
                            ...
                            "Text": {
                                "Value": "REFUNDABLE DEPOSIT INVOICE"
                            },
                            "HorAlignment": "Center",
                            "Font": "Microsoft Sans Serif;18;Bold;",
                            "Border": ";155,155,155;;;;;;solid:Black",
                        ...
                        "4": {
                            ...
                            "Text": {
                                "Value": "{refundable_deposit.serial_number}"
                            },
                            "Font": ";9;;",
                            "Border": ";;;;;;;solid:Black",
                            "Brush": "solid:",
                        ...
                        "6": {
                            ...
                            "Text": {
                                "Value": "{({refundable_deposit.date}).ToString(\"d MMM yyyy\")}"
                            },
                            "VertAlignment": "Center",
                            "Font": ";9;;",
                            "Border": ";;;;;;;solid:Black",
                ...
                "3": {
                    ...
                    "Components": {
                        "0": {
                            ...
                            "Name": "Text1",
                            "CanGrow": true,
                            "ClientRectangle": "100,0,460,20",
                            "Interaction": {
                                "Ident": "StiInteraction"
                            },
                            "Text": {
                                "Value": "{refundable_deposit_item.description}"
                            },
                            "CanBreak": true,
                            "Font": ";9;;",
                            "Border": ";;;;;;;solid:Black",
                        ...
                        "1": {
                            ...
                            "Name": "Text3",
                            "CanGrow": true,
                            "ClientRectangle": "650,0,70,20",
                            "Interaction": {
                                "Ident": "StiInteraction"
                            },
                            "Text": {
                                "Value": "{refundable_deposit_item.item_total}"
                            },
                            "CanBreak": true,
                            "HorAlignment": "Right",
                            "Font": ";9;;",
                    ...
                    "DataSourceName": "refundable_deposit_item"
                },
                "4": {
                    ...
                    "Components": {
                        ...
                        "1": {
                            ...
                            "Editable": true,
                            "Text": {
                                "Value": "{refundable_deposit.bill_total}"
                            },
                            "HorAlignment": "Right",
                            "VertAlignment": "Center",
                            "Font": ";9;Bold;",
                        ...
                        "4": {
                            ...
                            "Text": {
                                "Value": "{refundable_deposit.order_notes}"
                            },
                            "Font": ";9;;",
                            "Border": ";;;;;;;solid:Black",
                            "Brush": "solid:",
                        ...
                        "7": {
                            ...
                            "Editable": true,
                            "Text": {
                                "Value": "{refundable_deposit.items_total}"
                            },
                            "HorAlignment": "Right",
                            "VertAlignment": "Center",
                            "Font": ";9;Bold;",
                        ...
                        "10": {
                            ...
                            "Editable": true,
                            "Text": {
                                "Value": "{refundable_deposit.service_charges_total}"
                            },
                            "HorAlignment": "Right",
                            "VertAlignment": "Center",
                            "Font": ";9;Bold;",
                        ...
                        "13": {
                            ...
                            "Editable": true,
                            "Text": {
                                "Value": "{refundable_deposit.subtotal_before_discount}"
                            },
                            "HorAlignment": "Right",
                            "VertAlignment": "Center",
                            "Font": ";9;Bold;",
                        ...
                        "16": {
                            ...
                            "Editable": true,
                            "Text": {
                                "Value": "({Replace(Format(\"{0:N}\",{{refundable_deposit.discount_total}}), \" \", \",\")})"
                            },
                            "HorAlignment": "Right",
                            "VertAlignment": "Center",
                            "Font": ";9;Bold;",
