...
<head>
    ...
    <script type="text/javascript">
        var receipt_voucher_id = <?php echo json_encode($receipt_voucher_id); ?>;

        function onBeforeRender(args) {
            var report = args.report;
            report.dictionary.variables.getByName("receipt_voucher_id").valueObject = receipt_voucher_id;
        }
    </script>

    <?php
    $report = new StiReport();
    $report->loadFile("/get-receipt-voucher-data-report");
