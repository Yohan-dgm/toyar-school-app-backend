...
<head>
    ...
    <script type="text/javascript">
        var sport_fee_invoice_id = <?php echo json_encode($sport_fee_invoice_id); ?>;

        function onBeforeRender(args) {
            var report = args.report;
            report.dictionary.variables.getByName("sport_fee_invoice_id").valueObject = sport_fee_invoice_id;
        }
    </script>

    <?php
    $report = new StiReport();
    $report->loadFile("/get-sport-fee-invoice-data-report");
