...
<head>
    ...
    <script type="text/javascript">
        var purchase_order_id = <?php echo json_encode($purchase_order_id); ?>;

        function onBeforeRender(args) {
            var report = args.report;
            report.dictionary.variables.getByName("purchase_order_id").valueObject = purchase_order_id;
        }
    </script>

    <?php
    $report = new StiReport();
    $report->loadFile("/get-purchase-order-data-report");
