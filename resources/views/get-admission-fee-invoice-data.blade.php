...
<head>
    ...
    <script type="text/javascript">
        var admission_fee_invoice_id = <?php echo json_encode($admission_fee_invoice_id); ?>;

        function onBeforeRender(args) {
            var report = args.report;
            report.dictionary.variables.getByName("admission_fee_invoice_id").valueObject = admission_fee_invoice_id;
        }
    </script>

    <?php
    $report = new StiReport();
    $report->loadFile("/get-admission-fee-invoice-data-report");
