...
<head>
    ...
    <script type="text/javascript">
        var exam_bill_id = <?php echo json_encode($exam_bill_id); ?>;

        function onBeforeRender(args) {
            var report = args.report;
            report.dictionary.variables.getByName("exam_bill_id").valueObject = exam_bill_id;
        }
    </script>

    <?php
    $report = new StiReport();
    $report->loadFile("/get-exam-bill-data-report");
